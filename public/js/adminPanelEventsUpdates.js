    ...
    success: function(data, status) {
      ...
      $("#announcementTable").append(
        "<tr>" +
          ...
          announcement +
          "</td>" +
          '<td><span class="delAnnouncement fa fa-close" style="color:red;cursor:pointer;" id="' +
          "a" +
          data.id +
          '"></span></td>' +
          "</tr>"
...
$(document).on("click", "#addEvent", function() {
  ...
  var endDateFormatted =
    endDate.slice(8, 10) + "-" + endDate.slice(5, 8) + endDate.slice(0, 4);
    ...
    success: function(data, status) {
      ...
      $("#eventTable").append(
        "<tr>" +
          ...
          "</td>" +
          '<td><span class="delEvent fa fa-close" style="color:red;cursor:pointer;" id="' +
          data.id +
          '"></span></td>' +
          "</tr>"
      );
