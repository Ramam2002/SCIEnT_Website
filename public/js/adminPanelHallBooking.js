...
$(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(data, status) {
        $("#infoList").append(
          "<li>HallBooking id: " +
            data.id +
            "</li><li>Meeting Organiser Roll: " +
            data.roll +
            "</li><li>Meeting Organiser Name: " +
            data.name +
            "</li><li>Department: " +
            data.department +
            ...
            "</li><li>Email Id: " +
            data.emailID +
            "</li><li>Number of attendees :" +
            data.attendeesNumber +
            "</li><li>Purpose of booking: " +
            data.purpose +
            "</li><li>Meeting date: " +
            data.date +
            "</li><li>Request start time: " +
            data.startTime +
            "</li><li>Request end time: " +
            data.endTime +
            "</li><li>Approved start time: " +
            data.approvedStartTime +
            "</li><li>Approved end time: " +
            data.approvedEndTime +
            "</li>"
        );
        showModal();
      }
  ...
  $(document).on("click", ".approveForHallBooking", function() {
    var bookingId = $(this)
      ...
      .find(".bookingId")
      .text();
    var requestedStartTime = $(this)
      .closest("tr")
      .find(".applicantRequestedStartTime")
      .text();
    console.log(requestedStartTime);
    var requestedEndTime = $(this)
      .closest("tr")
      .find(".applicantRequestedEndTime")
      .text();
  ...
  $(document).on("click", ".removeForHallBooking", function() {
    ...
    var confirmation = confirm(
      "Are you sure you want to delete request corresponding to id " +
        bookingId +
        "?"
    );
  ...
  $(document).on("click", ".submitApprovalForHallBooking", function() {
    ...
    var confirmation = confirm(
      "Are you sure you want to approve this hall booking request?"
    );
    if (confirmation == true) {
      $.ajax({
